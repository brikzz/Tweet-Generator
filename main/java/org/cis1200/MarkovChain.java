...
public class MarkovChain implements Iterator<String> {
    ...
    void addBigram(String first, String second) {
        ...
        if (chain.containsKey(first)) {
            ...
            ProbabilityDistribution<String> newChain = new ProbabilityDistribution<>();
            newChain.record(second);
            chain.put(first, newChain);
        }
    }
    ...
    public boolean hasNext() {
        return startingWord != null && !startingWord.equals(END_TOKEN);
    }
    ...
    public String next() {
        ...
        ProbabilityDistribution<String> temp = new ProbabilityDistribution<>();
        if (!hasNext()) {
            ...
            if (!chain.containsKey(nextWord)) {
                ...
                temp = chain.get(nextWord);
                startingWord = temp.pick(ng);
            }

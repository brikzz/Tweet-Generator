...
public class TwitterBotTest {
    ...
    @Test
    public void twitterBotTestDuplicateWord() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList(
                        "this", "comes", "from", "data", "with", "duplicate", "words", ".",
                        "the", "end", "should", "duplicate", "."
                )
        );
        String words = "0, The end should duplicate here.\n"
                + "1, This comes from data with duplicate words!";
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        TwitterBot t = new TwitterBot(br, 1);
        t.fixDistribution(desiredTweet);
        ...
        String expected =
                "this comes from data with duplicate words. the end should duplicate.";

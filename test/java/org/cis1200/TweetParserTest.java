...
public class TweetParserTest {
    ...
    @Test
    public void testExtractColumnTooBig() {
        assertEquals(
                null,
                TweetParser.extractColumn(
                        "wrongColumn, wrong column, wrong column!, This is too big.", 7
                )
        );
    }

    @Test
    public void testExtractColumnTooSmall() {
        assertEquals(
                null,
                TweetParser.extractColumn(
                        "wrongColumn, wrong column, wrong column!, This is too small.", -2
                )
        );
    }
    ...
    @Test
    public void testCsvDataToTweetsNullColumn() {
        StringReader sr = new StringReader(
                "0, Dis da first lyin.\n" +
                        "1,\n" +
                            "2, Third line index 2."
        );
        BufferedReader br = new BufferedReader(sr);
        List<String> tweets = TweetParser.csvDataToTweets(br, 1);
        List<String> expected = new LinkedList<String>();
        expected.add(" Dis da first lyin.");
        expected.add(" Third line index 2.");
        assertEquals(expected, tweets);
    }

    @Test
    public void testCsvDataToTweetsTCTooBig() {
        StringReader sr = new StringReader(
                "0, Dis da first lyin.\n" +
    ...
    @Test
    public void testCsvDataToTweetsTCTooSmall() {
        StringReader sr = new StringReader(
                "0, Dis da first lyin.\n" +
                        "1,Second line index 1.\n" +
                        "2, Third line index 2."
    ...
    @Test
    public void testCsvDataToTweetsRandomNulls() {
        StringReader sr = new StringReader(
                "0, Tweeet,, another tweet.\n" +
                        "1,,, Something in the second line.\n" +
                        "2, Third line index 2., anotha one."
        );
        BufferedReader br = new BufferedReader(sr);
        List<String> tweets = TweetParser.csvDataToTweets(br, 1);
        List<String> expected = new LinkedList<String>();
    ...
    @Test
    public void parseAndCleanSentenceOnlyBadWords() {
    ...
    @Test
    public void testCsvDataToTrainingDataNull() {
        StringReader sr = new StringReader(
                "0, The end should come here.\n" +
                        "1, This comes from data with no duplicate words!"
        );
